...
const NftHistoryPage = () => {
    ...
    return (
        <div className="auction-history w-full max-w-[1200px] mx-auto my-8 p-4">
            ...
            <h3 className="name text-[#1c0971] md:text-6xl text-3xl">NFT Activities</h3>
                    ...
                    {nftDetails.activity.length === 0 ? (
                        ...
                        <ul className="min-w-[400px]">
                            {nftDetails.activity.map((activity) => (
                                <li
                                    key={activity._id}
                                    className="box-shadow p-4 rounded-lg shadow-md flex flex-col gap-1 mb-4"
                                >
                                    ...
                                    <p className="text-gray-700">
                                        ...
                                        <Link
                                            to={`${SUI_EXPLORER_URL}/tx/${activity.txDigest}`}
                                            target="_blank"
                                            className="underline"
                                        >
                                    ...
                                    <p className="text-gray-700">
                                        ...
                                        <Link
                                            to={`${SUI_EXPLORER_URL}/object/${activity.nftId}`}
                                            target="_blank"
                                            className="underline"
                                        >
